...
public class JedisClusterPipeline extends PipelineBase implements Closeable {
    ...
    public static void main(String[] args) throws IOException {
        ...
        nodes.add(new HostAndPort("192.168.204.128", 7528));
        nodes.add(new HostAndPort("192.168.204.198", 7529));
        nodes.add(new HostAndPort("192.168.204.130", 7530));
