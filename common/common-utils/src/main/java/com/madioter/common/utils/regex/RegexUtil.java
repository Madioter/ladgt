package com.madioter.common.utils.regex;
...
public class RegexUtil {
	...
	public static String replaceBlankSpan(String str) {
		return RegexUtil.replaceMatcher(str, "<SPAN style=\"FONT-SIZE: 0pt; COLOR: #ffffff\"[^>]*>[^<]*</SPAN>", "");
	}

	public static String toLink(String content) {
		content = RegexUtil.replaceMatcher(content, "((?:(?:http|ftp|https):\\/\\/){0,1}(?:(?:\\w|\\d)+\\.)+(?:\\S+))", "<a href=\"$1\">$1</a>");
		return content;
	}
