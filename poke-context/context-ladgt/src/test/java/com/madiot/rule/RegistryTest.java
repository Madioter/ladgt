...
public class RegistryTest extends TestCase {
    ...
    public void testPair() {
        ...
        pokeCardList.add(new LadgtPokeCard(LadgtPokeCard.CardType.BLACK, LadgtPokeCard.CardValue.JOKER));
        IOneHand oneHand = new LadgtOneHand(pokeCardList, configuration, 1);
    ...
    public void testBomb() {
        ...
        pokeCardList.add(new LadgtPokeCard(LadgtPokeCard.CardType.DIAMOND, LadgtPokeCard.CardValue.FIVE));
        pokeCardList.add(new LadgtPokeCard(LadgtPokeCard.CardType.HEART, LadgtPokeCard.CardValue.FIVE));
        LadgtOneHand oneHand = new LadgtOneHand(pokeCardList, configuration, 1);
        ...
        pokeCardList.add(new LadgtPokeCard(LadgtPokeCard.CardType.DIAMOND, LadgtPokeCard.CardValue.FIVE));
        pokeCardList.add(new LadgtPokeCard(LadgtPokeCard.CardType.HEART, LadgtPokeCard.CardValue.FIVE));
        LadgtOneHand oneHand2 = new LadgtOneHand(pokeCardList, configuration, 1);
        ...
        pokeCardList.add(new LadgtPokeCard(LadgtPokeCard.CardType.BLACK, LadgtPokeCard.CardValue.JOKER));
        pokeCardList.add(new LadgtPokeCard(LadgtPokeCard.CardType.BLACK, LadgtPokeCard.CardValue.JOKER));
        LadgtOneHand oneHand3 = new LadgtOneHand(pokeCardList, configuration, 1);
        ...
        pokeCardList.add(new LadgtPokeCard(LadgtPokeCard.CardType.RED, LadgtPokeCard.CardValue.JOKER));
        LadgtOneHand oneHand4 = new LadgtOneHand(pokeCardList, configuration, 1);
        ...
        LadgtOneHand oneHand5 = new LadgtOneHand(pokeCardList, configuration, 1);
